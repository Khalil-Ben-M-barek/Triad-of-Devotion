...
def run_setup_menu(virtual_screen, window, display_res, font, small_font, party, cursor_sound, confirm_sound, turn_order):
    ...
    while is_equipping:
        ...
        virtual_screen.blit(small_font.render("Equipped Enablers:", True, orange), (slot_x - 65, slot_y - 15))
        ...
        virtual_screen.blit(small_font.render("Available Enablers:", True, orange), (slot_x - 55, slot_y + 220))
